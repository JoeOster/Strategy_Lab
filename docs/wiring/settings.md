...
This document is the "contract" for all UI interactions, as defined in our `Strategy_Lab_V2_Plan.md`. It maps element IDs to their human-readable purpose and the specific handler function GCA (the Servant) is responsible for wiring.
